...
int main() {
	...
	*/
	...
	else
	{
		...
		// Forgive me for changing this here, but the way it was, it would have given me an error if I did things correctly.
		// I saw what you were attempting to do and fixed it. I hope that's all right. It'll be the one thing I change.
		if (greenlover->getLastName() != "Andre" && greenlover->getFirstName() != "Bartley")
		{
			errors++;
